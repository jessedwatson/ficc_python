'''
 ...
 # @ Modified time: 2022-01-25 14:50:09
...
def process_data(query,client,SEQUENCE_LENGTH,NUM_FEATURES,PATH,YIELD_CURVE="FICC", estimate_calc_date=True,remove_short_maturity=False, **kwargs):
