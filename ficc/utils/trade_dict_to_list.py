'''
 ...
 # @ Modified time: 2022-10-17 19:19:12
...
def trade_dict_to_list(trade_dict: dict, 
    ...
    return np.stack(trade_list) , (trade_dict['dollar_price'], trade_dict['calc_date'], trade_dict['maturity_date'], trade_dict['next_call_date'], trade_dict['par_call_date'], trade_dict['refund_date'], trade_dict['trade_datetime'], trade_dict['calc_day_cat'], trade_dict['settlement_date'])