...
def main():
    ...
    if not TESTING and model is None:
        ...
        try:
            ...
            send_results_email_multiple_tables(result_df_list, description_list, current_date, EMAIL_RECIPIENTS, 'dollar_price')
            # send_results_email_table(current_date_data_current_date_model_result_df, current_date, EMAIL_RECIPIENTS, 'dollar_price')
            # send_results_email(mae, current_date, EMAIL_RECIPIENTS, 'dollar_price')
